...
//Clase Principal, punto de entrada del programa y controla la lógica principal de la aplicación
public class Principal {
    ...
    //Método main, punto de entrada del programa, controla el flujo principal de la aplicación
    ...
    //Método ejecutarConversion, solicita al usuario los detalles de la conversión y la realiza,
    // además agrega la conversión al historial.
    private static void ejecutarConversion() {
        String[] divisas = {Divisas.USD, Divisas.ARS, Divisas.EUR, Divisas.BRL, Divisas.MXN,
                Divisas.CNY, Divisas.CHF, Divisas.GBP, Divisas.JPY};
    ...
    //Método mostrarResultado, muestra el resultado de la conversión al usuario
